...
const projectDatabase = [
    ...
    { id: "p3", name: "3. RFID Kapı Sistemi", required: ["Arduino Uno R3", "RFID Kit", "Servo Motor", "LCD Ekran"], 
      steps: [{ img: "Ardıino%20Proje%20Görselleri/rfid%20kapı%20sistemi.png", text: "RFID SPI bağlantılarını yapıp yetkili kartla kilidi açın." }] },
    ...
    { id: "p27", name: "27. Robot Süpürge", required: ["Arduino Uno R3", "Mesafe Sensörü", "Vakum Motoru", "Tekerlek"], 
      steps: [{ img: "Ardıino%20Proje%20Görselleri/robot%20süpürge.jpg", text: "Otonom süpürme sistemini tamamlayın." }]}
];
