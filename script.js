...
const projectDatabase = [
    { id: "p1", name: "1. Bluetooth Araba", required: ["Arduino Uno R3", "HC-06 Bluetooth", "L298N Motor Sürücü", "Redüktörlü Motor", "Tekerlek"], steps: [{ img: "Ardiino%20Proje%20Görselleri/Bluetooth%20araba.png", text: "ADIM 1: Bluetooth modülünü ve motor sürücü bağlantılarını kurun." }] },
    { id: "p2", name: "2. Engelden Kaçan Robot", required: ["Arduino Uno R3", "Mesafe Sensörü", "Servo Motor", "L298N Motor Sürücü", "Tekerlek"], steps: [{ img: "Ardiino%20Proje%20Görselleri/engelden%20kaçan%20araba.png", text: "ADIM 1: Mesafe sensörünü öne takıp otonom sürüşü kodlayın." }] },
    { id: "p3", name: "3. RFID Kapı Sistemi", required: ["Arduino Uno R3", "RFID Kit", "Servo Motor", "LCD Ekran"], steps: [{ img: "Ardiino%20Proje%20Görselleri/rfid%20kapı%20sistemi.png", text: "ADIM 1: RFID kart okunduğunda kilit servosunu aktif edin." }] },
    { id: "p4", name: "4. Yangın Alarmı", required: ["Arduino Uno R3", "Alev Sensörü", "Buzzer", "LED"], steps: [{ img: "Ardiino%20Proje%20Görselleri/yangın%20alarm%20sistemi.png", text: "ADIM 1: Alev algılandığında buzzer ile alarm verin." }] },
    { id: "p5", name: "5. Akıllı Sulama", required: ["Arduino Uno R3", "Nem Kontrol", "Su Pompası", "24V Röle"], steps: [{ img: "Ardiino%20Proje%20Görselleri/akıllı%20sulama.jpg", text: "ADIM 1: Toprak nemine göre pompayı otomatik çalıştırın." }] },
    { id: "p6", name: "6. Ses Kontrollü Işık", required: ["Arduino Uno R3", "Mikrofon Modülü", "24V Röle"], steps: [{ img: "Ardiino%20Proje%20Görselleri/ses%20kontrollü%20ışık.jpg", text: "ADIM 1: Ses eşiği aşıldığında röleyi tetikleyin." }] },
    { id: "p7", name: "7. Joystick Araba", required: ["Arduino Uno R3", "Joystick", "L298N Motor Sürücü", "Tekerlek"], steps: [{ img: "Ardiino%20Proje%20Görselleri/joystick%20kontrollü%20araba.jpg", text: "ADIM 1: Joystick ile motorlara yön verin." }] },
    { id: "p12", name: "12. Nabız Ölçer", required: ["Arduino Uno R3", "Nabız Sensörü", "OLED Ekran"], steps: [{ img: "Ardiino%20Proje%20Görselleri/nabız%20ölçer.jpg", text: "ADIM 1: Kalp ritmini OLED ekranda grafikleyin." }] },
    { id: "p13", name: "13. Akıllı Sera", required: ["Arduino Uno R3", "Nem Kontrol", "DHT11 Sıcaklık Sensörü", "LCD Ekran"], steps: [{ img: "Ardiino%20Proje%20Görselleri/akıllı%20sera.jpg", text: "ADIM 1: Sera içi değerleri anlık izleyin." }] },
    { id: "p16", name: "16. Park Sensörü", required: ["Arduino Uno R3", "Mesafe Sensörü", "Buzzer", "LED"], steps: [{ img: "Ardiino%20Proje%20Görselleri/park%20sensörü.jpg", text: "ADIM 1: Mesafeye göre sesli ve görsel uyarı kurun." }] },
    { id: "p17", name: "17. Çizgi İzleyen", required: ["Arduino Uno R3", "L298N Motor Sürücü", "Çizgi Sensörü", "Tekerlek"], steps: [{ img: "Ardiino%20Proje%20Görselleri/çizgi%20izleyen%20araba.jpg", text: "ADIM 1: Siyah çizgiyi takip eden sistemi kurun." }] },
    { id: "p18", name: "18. Yüz Tanıma", required: ["ESP32-Cam", "24V Röle", "OLED Ekran"], steps: [{ img: "Ardiino%20Proje%20Görselleri/yüz%20tanıma%20sistemi.jpg", text: "ADIM 1: Tanımlı yüzü görünce röleyi açın." }] },
    { id: "p19", name: "19. Labirent Oyunu", required: ["Arduino Nano", "Joystick", "Servo Motor"], steps: [{ img: "Ardiino%20Proje%20Görselleri/labirent%20oyunu.jpg", text: "ADIM 1: Joystick ile labirent tablasını eğin." }] },
    { id: "p20", name: "20. Otto Robot", required: ["Arduino Nano", "Servo Motor", "Mesafe Sensörü"], steps: [{ img: "Ardiino%20Proje%20Görselleri/otto%20robot.jpg", text: "ADIM 1: Nano ile 4 servoyu yürütün." }] },
    { id: "p21", name: "21. Renk Ayırıcı", required: ["Arduino Nano", "Renk Sensörü", "Servo Motor"], steps: [{ img: "Ardiino%20Proje%20Görselleri/renk%20ayırıcı.jpg", text: "ADIM 1: Renge göre servoyu döndürün." }] },
    { id: "p23", name: "23. Ateş Ölçer", required: ["Arduino Nano", "DHT11 Sıcaklık Sensörü", "LCD Ekran"], steps: [{ img: "Ardiino%20Proje%20Görselleri/ateş%20ölçer.jpg", text: "ADIM 1: Isı verisini LCD ekrana yazdırın." }] },
    { id: "p24", name: "24. Akıllı Saat", required: ["Arduino Nano", "RTC Saat Modülü", "OLED Ekran"], steps: [{ img: "Ardiino%20Proje%20Görselleri/akıllı%20saat.jpg", text: "ADIM 1: Giyilebilir dijital saat yapın." }] },
    { id: "p25", name: "25. Su Terazisi", required: ["Arduino Nano", "ADXL345 Eğim Sensörü", "OLED Ekran"], steps: [{ img: "Ardiino%20Proje%20Görselleri/dijital%20su%20terazisi.jpg", text: "ADIM 1: Eğim derecesini ekranda gösterin." }] },
    { id: "p26", name: "26. Parmak İzi Kasa", required: ["Arduino Nano", "Parmak İzi", "Step Motor"], steps: [{ img: "Ardiino%20Proje%20Görselleri/parmak%20izi%20okuyucu%20ile%20kasa%20kilidi.jpg", text: "ADIM 1: Parmak iziyle kilidi açın." }] },
    { id: "p27", name: "27. Robot Süpürge", required: ["Arduino Uno R3", "Mesafe Sensörü", "Vakum Motoru", "Redüktörlü Motor", "Tekerlek"], steps: [{ img: "Ardiino%20Proje%20Görselleri/robot%20süpürge.jpg", text: "ADIM 1: Otonom süpürme sistemi yapın." }] }
];
