...
const materialData = {
    ...
    "Arduino Uno R3": { img: "Arduino%20Atölyesi/arduino_uno.jpg", desc: "Sistemin ana kontrol ünitesi." },
    ...
    "Krokodil Kablo": { img: "Arduino%20Atölyesi/krokodil.jpg", desc: "Hızlı test kablosu." },
    ...
    "Piezo Buzzer": { img: "Arduino%20Atölyesi/piezo_buzzer.jpg", desc: "Titreşimle ses." },
    ...
    "Tekerlek": { img: "Arduino%20Atölyesi/tekerlek.jpg", desc: "Robot tekerleği." }, // Küçük harf yapıldı
...
const projectDatabase = [
    ...
    { id: "p3", name: "3. RFID Kapı Sistemi", required: ["Arduino Uno R3", "RFID Kit", "Servo Motor", "LCD Ekran"], 
      steps: [{ img: "Ardıino%20Proje%20Görselleri/rfıd%20kapı%20sistemi.png", text: "RFID SPI bağlantılarını yapıp yetkili kartla kilidi açın." }] },
    { id: "p4", name: "4. Yangın Alarm Sistemi", required: ["Arduino Uno R3", "Ateş Sensörü", "Buzzer", "LED"], // Alev Sensörü -> Ateş Sensörü yapıldı
      steps: [{ img: "Ardıino%20Proje%20Görselleri/yangın%20alarm%20sistemi.png", text: "Alev algılandığında buzzer ile alarm çalın." }] },
    { id: "p5", name: "5. Akıllı Sulama", required: ["Arduino Uno R3", "Nem Kontrol", "Su Pompası"], 
      steps: [{ img: "Ardıino%20Proje%20Görselleri/akıllı%20sulama%20.jpg", text: "Toprak nemi düştüğünde pompayı otomatik çalıştırın." }] },
    { id: "p6", name: "6. Ses Kontrollü Işık", required: ["Arduino Uno R3", "Mikrofon Modülü", "24V Röle"], 
      steps: [{ img: "Ardıino%20Proje%20Görselleri/ses%20kontrollü%20ışık.jpg", text: "Ses eşiği aşıldığında ışığı açan devreyi kurun." }] },
    { id: "p7", name: "7. Joystick Kontrollü Araba", required: ["Arduino Uno R3", "Joystick", "L298N Motor Sürücü", "Tekerlek"], 
      steps: [{ img: "Ardıino%20Proje%20Görselleri/joystick%20kontrollü%20araba.jpg", text: "Joystick hareketlerini motor yönlerine atayın." }] },
    { id: "p8", name: "8. IR Kumandalı Robot", required: ["Arduino Uno R3", "IR Kumanda Kiti", "L298N Motor Sürücü", "Tekerlek"], 
      steps: [{ img: "Ardıino%20Proje%20Görselleri/ır%20kumandalı%20robot.jpg", text: "Kumanda tuşlarıyla robotu uzaktan yönetin." }] },
    { id: "p9", name: "9. Güvenlik Sistemi", required: ["Arduino Uno R3", "PIR Sensör", "Buzzer", "Keypad"], 
      steps: [{ img: "Ardıino%20Proje%20Görselleri/güvenlik%20sistemi.jpg", text: "Hareket algılandığında şifre istenen sistemi kurun." }] },
    { id: "p10", name: "10. Gaz Alarmı", required: ["Arduino Uno R3", "Gaz Sensörü", "Buzzer", "LCD Ekran"], 
      steps: [{ img: "Ardıino%20Proje%20Görselleri/gaz%20alarmı.jpg", text: "Sızıntı anında LCD'de uyarı gösterin." }] },
    { id: "p11", name: "11. WiFi Kamera Sistemi", required: ["ESP32-Cam", "PIR Sensör", "9V Pil"], 
      steps: [{ img: "Ardıino%20Proje%20Görselleri/wifi%20kamera%20sistemi.jpg", text: "Hareket olunca WiFi üzerinden görüntü aktarın." }] },
    { id: "p12", name: "12. Nabız Ölçer", required: ["Arduino Uno R3", "Nabız Sensörü", "LCD Ekran"], 
      steps: [{ img: "Ardıino%20Proje%20Görselleri/nabız%20ölçer.jpg", text: "Kalp ritmini hesaplayıp ekranda grafikleyin." }] },
    { id: "p13", name: "13. Akıllı Sera", required: ["Arduino Uno R3", "Nem Kontrol", "DHT11 Sıcaklık Sensörü", "LCD Ekran"], 
      steps: [{ img: "Ardıino%20Proje%20Görselleri/akıllı%20sera.jpg", text: "Sera verilerini LCD ekrandan takip edin." }] },
    { id: "p14", name: "14. Saat Sistemi", required: ["Arduino Uno R3", "RTC Saat Modülü", "7 Segment Ekran"], 
      steps: [{ img: "Ardıino%20Proje%20Görselleri/saat%20sistemi.jpg", text: "Güncel saati sayısal ekranda gösterin." }] },
    { id: "p15", name: "15. Touch Kontrollü Araba", required: ["Arduino Uno R3", "Touch Pad", "L298N Motor Sürücü", "Tekerlek"], 
      steps: [{ img: "Ardıino%20Proje%20Görselleri/touch%20kontrollü%20araba.jpg", text: "Dokunmatik yüzeyle aracı yönlendirin." }] },
    { id: "p16", name: "16. Akıllı Park Sensörü", required: ["Arduino Uno R3", "Mesafe Sensörü", "Buzzer", "LED"], 
      steps: [{ img: "Ardıino%20Proje%20Görselleri/park%20sensörü.jpg", text: "Mesafeye göre ses hızını ayarlayan sistemi kurun." }] },
    { id: "p17", name: "17. Çizgi İzleyen", required: ["Arduino Uno R3", "L298N Motor Sürücü", "Çizgi Sensörü", "Tekerlek"], 
      steps: [{ img: "Ardıino%20Proje%20Görselleri/çizgi%20izleyen%20araba.jpg", text: "Siyah çizgiyi takip eden sistemi kurun." }] },
    { id: "p18", name: "18. Yüz Tanıma", required: ["ESP32-Cam", "24V Röle", "OLED Ekran"], 
      steps: [{ img: "Ardıino%20Proje%20Görselleri/yüz%20tanıma%20sistemi.jpg", text: "Kayıtlı yüzü görünce geçit verin." }] },
    { id: "p19", name: "19. Labirent Oyunu", required: ["Arduino Nano", "Joystick", "Servo Motor"], 
      steps: [{ img: "Ardıino%20Proje%20Görselleri/labirent%20oyunu.jpg", text: "Joystick ile tablasını hareket ettirin." }] },
    { id: "p20", name: "20. Otto Robot", required: ["Arduino Nano", "Servo Motor", "Mesafe Sensörü"], 
      steps: [{ img: "Ardıino%20Proje%20Görselleri/otto%20robot.jpg", text: "Nano ve servolarla yürüyen robotu kurun." }] },
    { id: "p21", name: "21. Renk Ayırıcı", required: ["Arduino Nano", "Renk Sensörü", "Servo Motor"], 
      steps: [{ img: "Ardıino%20Proje%20Görselleri/renk%20ayırıcı.jpg", text: "Renge göre servoyu doğru kutuya döndürün." }] },
    { id: "p22", name: "22. Sumo Robot", required: ["Arduino Uno R3", "L298N Motor Sürücü", "Tekerlek", "Çizgi Sensörü"], 
      steps: [{ img: "Ardıino%20Proje%20Görselleri/sumo%20robot.jpg", text: "Rakibi dışarı atan savaşçı robotu yapın." }] },
    { id: "p23", name: "23. Ateş Ölçer", required: ["Arduino Nano", "DHT11 Sıcaklık Sensörü", "LCD Ekran"], 
      steps: [{ img: "Ardıino%20Proje%20Görselleri/ateş%20ölçer.jpg", text: "Isıyı ölçüp ekrana yazdırın." }] },
    { id: "p24", name: "24. Akıllı Saat", required: ["Arduino Nano", "RTC Saat Modülü", "OLED Ekran"], 
      steps: [{ img: "Ardıino%20Proje%20Görselleri/akıllı%20saat.jpg", text: "Giyilebilir bir saat tasarlayın." }] },
    { id: "p25", name: "25. Su Terazisi", required: ["Arduino Nano", "ADXL345 Eğim Sensörü", "OLED Ekran"],
      steps: [{ img: "Ardıino%20Proje%20Görselleri/dijital%20su%20terazisi.jpg", text: "Eğim derecesini ekranda gösterin." }] },
    { id: "p26", name: "26. Parmak İzi Kasa", required: ["Arduino Nano", "Parmak İzi", "Servo Motor"], 
      steps: [{ img: "Ardıino%20Proje%20Görselleri/parmak%20izi%20okuyucu%20ile%20kasa%20kilidi.jpg", text: "Parmak iziyle kilidi açan kasa yapın." }] },
    { id: "p27", name: "27. Robot Süpürge", required: ["Arduino Uno R3", "Mesafe Sensörü", "Vakum Motoru", "Tekerlek"], 
      steps: [{ img: "Ardıino%20Proje%20Görselleri/robot%20süpürge.jpg", text: "Otonom süpürme sistemini tamamlayın." }]} // Yarım kalan proje kapatıldı
];
